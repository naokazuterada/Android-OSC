...
public class Unit extends net.karappo.android.osc.view.Unit
{
	...
	public net.karappo.android.osc.view.AnimLayout init(Main main, int id)
	{
		this.id = id;
		idTV.setText(id+"");
	...
	private net.karappo.android.osc.view.bounce.AnimLayout cast(AnimLayout view)
	{
		return (net.karappo.android.osc.view.bounce.AnimLayout) view;
	}
}
