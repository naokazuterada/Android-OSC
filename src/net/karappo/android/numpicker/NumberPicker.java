...
package net.karappo.android.numpicker;
...
public class NumberPicker extends LinearLayout implements OnClickListener,OnFocusChangeListener, OnLongClickListener
{
   ...
   // @SuppressWarnings({"UnusedDeclaration"})
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) 
    {
        ...
        inflater.inflate(R.layout.numpicker, this, true);
	    ...
	    TypedArray tArray = context.obtainStyledAttributes(attrs, R.styleable.NumberPicker);
	    mStart = tArray.getInt(R.styleable.NumberPicker_min, DEFAULT_MIN);
	    mEnd = tArray.getInt(R.styleable.NumberPicker_max, DEFAULT_MAX);
